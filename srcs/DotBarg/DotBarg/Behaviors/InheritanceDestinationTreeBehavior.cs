...
{
    public class InheritanceDestinationTreeBehavior : Behavior<CanvasEx>
    {
        ...
        public static readonly DependencyProperty InheritanceDestinationTreeItemsProperty =
            DependencyProperty.Register(
                nameof(InheritanceDestinationTreeItems),
                typeof(ObservableCollection<DefinitionItemModel>),
                typeof(InheritanceDestinationTreeBehavior),
                new PropertyMetadata(null, OnInheritanceDestinationTreeItemsPropertyChanged));

        public ObservableCollection<DefinitionItemModel> InheritanceDestinationTreeItems
        {
            get { return GetValue(InheritanceDestinationTreeItemsProperty) as ObservableCollection<DefinitionItemModel>; }
            set { SetValue(InheritanceDestinationTreeItemsProperty, value); }
        }

        private static void OnInheritanceDestinationTreeItemsPropertyChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
        {
